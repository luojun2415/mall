            ...
            <div id="con">
                ...
                <div id="tagContent">
                    <div class="tagContent selectTag">
                        <form id="form1" method="post" action="{$baseUrl}/Login/LoginCheck">
                        ...
                        <table style="color: #555555" cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <a class="fr">
                                        <img alt="验证码" id='checkCode' style="cursor:pointer;" border="0"/></a>
                            ...
                            <tr>
                                <td colspan="3" height="80" align="center">
                                    <label>
                                      <input name="" value="" id="submitForm" class="button" type="button"><label>
...
{script}
	...
	$("#checkCode").click(function() {
		$(this).attr('src','{$baseUrl}/Login/GetCode?t='+Math.random());
	});
