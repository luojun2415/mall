<?php /* Smarty version Smarty-3.1.6, created on 2014-08-26 08:38:30
         compiled from "res/template\default\page\login\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:989653fbd706b0fb93-84309978%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83c21a3cb866754b7dfed6ad1e49c5e53d4480f2' => 
    array (
      0 => 'res/template\\default\\page\\login\\index.tpl',
      1 => 1408934628,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '989653fbd706b0fb93-84309978',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53fbd706e2b48',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53fbd706e2b48')) {function content_53fbd706e2b48($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<?php  ?><html><head>
...
<body>
    <div id="main" style="margin-top:25px;">
        <div class="header_logo">
            <div class="logo">
              <img src="http://dev.mall.com/res/static/default/page/login/img/logo.gif" />
              <!-- 食材专区登录图片 -->
              <!-- <img src="http://172.18.105.61:801/2014/shicaiZone/css/food/img/logo_login.png"></img> -->
            </div>
            
            <div class="fl">
              <a href="http://www.xinfuka.net/"><img src="http://dev.mall.com/res/static/default/page/login/img/home_1.png" title="首页" /></a>
            </div>
            
        </div>
       <div  class="login_bg shadow" style="margin-top:15px;">
       <div class="login_right fr"><img src="http://dev.mall.com/res/static/default/page/login/img/4.gif"></img></div>
...
/Login/LoginCheck" onsubmit="return formCheck()">
...
/Login/GetCode" style="cursor:pointer;" border="0"/></a>
...
<?php $script=ob_get_clean();if($script!==false){if(!class_exists('FISResource')){require_once('C:/Users/John/Downloads/thinkphp_3.2.2_full/Application/Common/Lib/Smarty/plugins/FISResource.class.php');}FISResource::addScriptPool($script);}?>
        <div id="footer">
            <div class="footer_cn">
                ...
                <img src="http://dev.mall.com/res/static/default/page/login/img/23.gif" height="20" border="0" width="20"></a>

                <br>
                Copyright © 2004-2010 薪福卡公司 版权所有 京ICP备10218204号 京ICP证110135号 京公海网安备110108000889号
                <img src="http://dev.mall.com/res/static/default/page/login/img/beian.jpg" align="absmiddle" border="0"></div>
        </div>
