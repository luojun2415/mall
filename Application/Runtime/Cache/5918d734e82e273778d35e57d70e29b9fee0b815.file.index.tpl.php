...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1787953fbdcb5eb5db4-33983690',
  'function' => 
  array (
  ),
  'variables' => 
      ...
      <div class="xilian_div">
      	<ul class="xilian_ul">
      		...
      		<li class="xilian_li">
			    ...
			    <a href="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/Search/Index/空中/1">
				<img src="http://dev.mall.com/res/static/default/page/main/product/ad/ad6.jpg" width="213px"/></a>
			 ...
			 <li class="xilian_li">
			    <a href="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/Search/Index/美通卡/1">
				<img width="213px;"   src="http://dev.mall.com/res/static/default/page/main/product/ad/mtk.png"/></a>
			 </li>
			  <!-- 薪福亚马逊乐享卡 结束 -->
			 ...
			 <li class="xilian_li">
			    <a href="<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/Search/Index/食材/1">
				<img width="213px;"   src="http://dev.mall.com/res/static/default/page/main/product/ad/dthsc.png"/></a>
			 </li>
			  <!-- 薪福客户端 结束-->
			 
			 <!--二维码充值 --> 
			 <li class="xilian_li">
				<img width="213px;"   src="http://dev.mall.com/res/static/default/page/main/product/ad/ad3.jpg"/>
			 </li>
			 <!-- 二维码--100充值 -->
		</ul>
      </div>
  ...
  <div> <!--顶部产品广告-->
      <div id="slideP" class="border_bsolid l">
	    ...
	    <div class="box"  >
	     	<a href="#">
	     		<img style="width: 258px;" src="http://dev.mall.com/res/static/default/page/main/product/ad/ad1312.gif"/>
	     	</a>
	    </div>
   </div>
