<?php /* Smarty version Smarty-3.1.6, created on 2014-08-27 09:15:30
         compiled from "res/template\default\page\Main\Index\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:920853fbe29456a794-91041197%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '96d0536d37a8dc40fff06d056de9e9c9a0903547' => 
    array (
      0 => 'res/template\\default\\page\\Main\\Index\\index.tpl',
      1 => 1409101418,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '920853fbe29456a794-91041197',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_53fbe294a2ad1',
  'variables' => 
  array (
    'description' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_53fbe294a2ad1')) {function content_53fbe294a2ad1($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\Users\\John\\Downloads\\thinkphp_3.2.2_full\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!DOCTYPE html>
...
/NewsCenter/Index/XF/2/1" id="xfMore">MORE</a>
  ...
  <div class="homeright" style="min-height: 477px;">
    ...
    <div class="clr"></div>
    <div><img src="http://dev.mall.com/res/static/default/page/main/index/ad2.jpg" border="0" gid="1" width="258"  height="57" ></img></div>
    <div class="clar"></div>     
   <div class="bgwhite box"><br><img src="http://dev.mall.com/res/static/default/page/main/index/ad3.jpg"   gid="1"><br><br></div>
  </div>
  <div class="clar"></div>
 <div class="homeleft">
 <div class="discount box bgwhite"  style="width:100%;"> 
    ...
    <div class="discount list" id="xftj">   
  	...
  	<img alt="" class="box" src="http://dev.mall.com/res/static/default/page/main/index/adxfwx.jpg">
  </div>
...
/NewsCenter/GetHomeNewsAndNotice/MS/2/1',{},function(data){
	$("#msInfos").html(data);
});
//幸福人生新闻
$.get('<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/NewsCenter/GetHomeNewsAndNotice/XF/2/1',{},function(data){
	$("#xfInfos_news").html(data);
});
//幸福人生公告
$.get('<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/NewsCenter/GetHomeNewsAndNotice/XF/0/1',{},function(data){
	$("#xfInfos_notice").html(data);
});
//首页轮播图
$.post('<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/AsynRequest/GetSlideList',{},function(result){
	$("#slide").html(result);
});
//幸福人生公告
$.get('<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
